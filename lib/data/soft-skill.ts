...
export const softSkillData = {
  ...
  themes: [
    ...
    },
    {
      id: 3,
      quality: "Kharisma",
      title: "Menyayangi manusia, dalam wujud memaafkan dan memaklumi.",
    ...
    },
    {
      ...
      indicators: [
        {
          title: "Konsistensi dalam banyak hal.",
          sub_indicators: [
            ...
            "Istiqomah pada bidang yang ditekuninya.",
          ]
        },
        {
          title: "Mengenal dengan baik apa tujuannya.",
          sub_indicators: [
            "Mengumpulkan banyak argumentasi syariah dari tujuan yang dicanangkan.",
            "Mengumpulkan banyak argumentasi logis dari tujuan yang dicanangkan.",
          ]
        },
        {
          title: "Istiqomah pada jalan menuju tujuan.",
          sub_indicators: [
            "Tidak mudah terdistraksi / menyimpang dari jalan menuju tujuan.",
            "Berani menolak ajakan yang bertentangan tujuannya.",
          ]
        },
        {
          title: "Siap berkurban demi tujuannya.",
          sub_indicators: [
        ...
        {
          title: "Tujuan yang dicanangkan bernilai akhirat dan duniawi.",
          sub_indicators: [
            "Meyakini bahwa kesetiaan pada tujuan adalah bagian dari ibadah.",
            "Mencapai tujuan dengan ketaatan kepada syariat.",
            "Tujuannya bernilai duniawi juga, tetapi prioritas prosesnya tetap pada syariat.",
          ]
        },
      ]
    },
    {
      ...
      indicators: [
        ...
        {
          title: "Tidak komersil dalam hal menolong.",
          sub_indicators: [
        ...
        },
        {
          ...
          sub_indicators: [
            ...
            "Mengutamakan ukhuwah/ikatan meski harus mengalah.",
          ]
        },
        {
    ...
    },
    {
      ...
      indicators: [
        ...
        },
        {
          ...
          sub_indicators: [
            "Menyelesaikan konflik dengan adab dan kasih sayang.",
            "Menjadikan musyawarah sebagai cara mengambil keputusan bersama.",
          ]
        },
      ]
    },
    {
      ...
      indicators: [
        ...
        },
        {
          ...
          sub_indicators: [
            "Tidak menyalahkan orang lain apabila ada dampak buruk.",
        ...
        {
          title: "Ingin memperkecil risiko atau dampak buruk terhadap orang lain..",
          sub_indicators: [
        ...
        },
        {
          ...
          sub_indicators: [
            ...
            "Menjadikan keberanian sebagai bentuk ibadah jihad.",
          ]
        },
      ]
    },
    ...
    },
    {
      ...
      indicators: [
        {
          title: "Tegas dalam memberikan perintah.",
          sub_indicators: [
