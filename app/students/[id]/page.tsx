...
export default async function StudentProfile({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!student) return <div className="p-10 text-center text-slate-500 font-medium">Student not found.</div>;
        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-slate-400 text-xs font-bold uppercase tracking-[0.2em] flex items-center gap-2 mt-1">
              <User size={12} className="text-emerald-500" /> {student.batch || 'Reguler Batch'}
            </p>
          </div>
        </div>
      </div>
      ...
      <main className="px-6 -mt-6 space-y-8">
        ...
        <section>
          <div className="flex items-center justify-between mb-5 px-3">
            <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Assessment History</h3>
          ...
          <div className="space-y-4">
            {reports && reports.length > 0 ? (
                ...
                >
                  <div className="flex items-center gap-5">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="font-black text-slate-900 text-sm mb-1">Assessment Review</p>
              ...
              <div className="text-center py-16 bg-white rounded-[3rem] border border-dashed border-slate-200 text-slate-400">
                ...
                <p className="text-xs font-bold uppercase tracking-widest">No reports found yet.</p>
              </div>
            )}
          </div>
        </section>
